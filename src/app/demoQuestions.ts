...
export const demoQuestions: Question[] = [
  {
    ...
    subjectId: 'matematica', language: null, kind: 'single-choice', files: [],
  ...
  },
  {
    ...
    subjectId: 'linguagens', language: null, kind: 'single-choice', files: [],
  ...
  },
  {
    ...
    subjectId: 'ciencias-humanas', language: null, kind: 'single-choice', files: [],
  ...
  },
  {
    ...
    subjectId: 'ciencias-natureza', language: null, kind: 'single-choice', files: [],
